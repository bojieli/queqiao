...
The links below are v0.8.0, the current release; the
[releases page](https://github.com/bojieli/queqiao/releases/latest) always has the newest.

| Platform | Status | Download |
| --- | --- | --- |
| macOS, Apple silicon | Desktop and gateway, ready to use | [`darwin_arm64`](https://github.com/bojieli/queqiao/releases/download/v0.8.0/queqiaod_v0.8.0_darwin_arm64_signed.zip), notarized |
| macOS, Intel | Desktop and gateway, ready to use | [`darwin_amd64`](https://github.com/bojieli/queqiao/releases/download/v0.8.0/queqiaod_v0.8.0_darwin_amd64_signed.zip), notarized |
| Linux, x86-64 | Desktop and gateway, ready to use | [`linux_amd64`](https://github.com/bojieli/queqiao/releases/download/v0.8.0/queqiaod_v0.8.0_linux_amd64.tar.gz) |
| Linux, arm64 | Desktop and gateway, ready to use | [`linux_arm64`](https://github.com/bojieli/queqiao/releases/download/v0.8.0/queqiaod_v0.8.0_linux_arm64.tar.gz) |
| Windows, x86-64 | Native target built; under testing, not production-ready | [`windows_amd64`](https://github.com/bojieli/queqiao/releases/download/v0.8.0/queqiaod_v0.8.0_windows_amd64.zip) |
| Windows, arm64 | Native target built; under testing, not production-ready | [`windows_arm64`](https://github.com/bojieli/queqiao/releases/download/v0.8.0/queqiaod_v0.8.0_windows_arm64.zip) |
...
[`SHA256SUMS`](https://github.com/bojieli/queqiao/releases/download/v0.8.0/SHA256SUMS)
